...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
      <el-table-column label="团队名称" align="center" prop="groupName"/>
      <el-table-column label="负责人名称" align="center" prop="managerName"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="团队名称" prop="groupName">
          <el-input v-model="form.groupName" placeholder="请输入团队名称"/>
        </el-form-item>
        ...
        <el-form-item label="团队顺序" prop="groupSort">
          <el-input-number v-model="form.groupSort" controls-position="right" :min="0"/>
        </el-form-item>
...
<script>
  import {listGroup, getGroup, delGroup, addGroup, updateGroup, exportGroup, listSalesMan} from "@/api/customer/group";
  ...
  export default {
    ...
    methods: {
      ...
      handleDetail(row) {
        this.$router.push({path: "/group/detail", query: {groupId: row.groupId}});
      },
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除团队编号为"' + groupIds + '"的数据项?', "警告", {
