<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="学院编码" prop="collegeNo">
        <el-input
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="collgeeList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="学院编号" align="center" prop="collegeId" />
      <el-table-column label="学院编码" align="center" prop="collegeNo" />
      <el-table-column label="学院名称" align="center" prop="name" />
      <el-table-column label="学院描述" align="center" prop="description" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学院编码" prop="collegeNo">
          <el-input v-model="form.collegeNo" placeholder="请输入学院编码" />
        </el-form-item>
        <el-form-item label="学院顺序" prop="collegeSort">
          <el-input-number v-model="form.collegeSort" controls-position="right" :min="0" />
        </el-form-item>
...
<script>
import { listCollege, getCollege, delCollege, addCollege, updateCollege, exportCollege } from "@/api/system/college";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        collegeNo: [
          { required: true, message: "学院编码不能为空", trigger: "blur" }
        ],
        collegeSort: [
          { required: true, message: "学院顺序不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    getList() {
      ...
      listCollege(this.queryParams).then(response => {
        this.collgeeList = response.rows;
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除学院编号为"' + collegeIds + '"的数据项?', "警告", {
